...
\section{Energy consumption on STM32F3} % Sections are added in order to organize your presentation into discrete blocks, all sections and subsections are automatically output to the table of contents as an overview of the talk but NOT output in the presentation as separate slides
...
%------------------------------------------------
\subsection*{Moving insturctions in CCM impact}
\begin{frame}
	\frametitle{Impact on energy}
	\begin{figure}
		\centering
        \includegraphics[scale=0.6]{plot/code_ccm_energy.pdf}
        \caption{}
