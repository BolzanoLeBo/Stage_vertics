...
\begin{frame}
	\frametitle{Energy decrease when instruction are moved in CCM}
	\begin{figure}
		\centering
        \includegraphics[scale=0.7]{plot/code_ccm_energy.pdf}
        \label{fig:code_ccm_energy}
	\end{figure}
	Moving instruction in CCM SRAM can overall improve energy consumption 
\end{frame}

\begin{frame}
	\frametitle{Runtime decrease when instruction are moved in CCM}
	\begin{figure}
		\centering
        \includegraphics[scale=0.7]{plot/code_ccm_runtime.pdf}
        \label{fig:code_ccm_runtime}
	\end{figure}
	In high frequencies the runtime is reduced when code is moved in CCM SRAM.
\end{frame}

\begin{frame}
	\frametitle{intensiy decrease when instruction are moved in CCM}
	\begin{figure}
		\centering
        \includegraphics[scale=0.7]{plot/code_ccm_intensity.pdf}
        \label{fig:code_ccm_intensity}
	\end{figure}
	In high frequencies, intensity when the code is running from flash is lowered.
\end{frame}
